...
tabla_bn <- data.frame(Criterio = criterios_bn, Aplica = aplica_bn, Detalles = detalles_bn)

tabla_bn %>%
  gt() %>%
  tab_header(
    title = "Guía rápida para elegir Redes Bayesianas (BN)",
    subtitle = "Modelado Probabilístico con Dependencias Condicionales"
  ) %>%
  tab_footnote(footnote = "Fuente: Elaboración propia") %>%
  tab_options(
...
tabla_blr %>%
  gt() %>%
  tab_header(
    title = "Guía rápida para elegir Bayesian Linear Regression (BLR)",
    subtitle = "Regresión Lineal desde una Perspectiva Bayesiana"
  ) %>%
  tab_footnote(footnote = "Fuente: Elaboración propia") %>%
  tab_options(
    heading.title.font.size = 14,
...
tabla_hmm %>%
  gt() %>%
  tab_header(
    title = "Guía rápida para elegir Hidden Markov Models (HMMs)",
...
tabla_kalman %>%
  gt() %>%
  tab_header(
    title = "Guía rápida para elegir el Filtro de Kalman",
    subtitle = "Estimación Óptima de Estados en Sistemas Dinámicos"
  ) %>%
  tab_footnote(footnote = "Fuente: Elaboración propia") %>%
  tab_options(
    heading.title.font.size = 14,
...
tabla_particle_filter %>%
  gt() %>%
  tab_header(
    title = "Guía rápida para elegir el Filtro de Partículas",
    subtitle = "Estimación de Estados en Sistemas No Lineales y No Gaussianos"
  ) %>%
  tab_footnote(footnote = "Fuente: Elaboración propia") %>%
  tab_options(
    heading.title.font.size = 14,
