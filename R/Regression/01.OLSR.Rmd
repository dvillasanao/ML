...
| ------------------------------------ | ------- |--------------------------- |
| **RMSE** *(Root Mean Squared Error)* | `2.63`  | El error promedio en las predicciones es de **2.63 millas por galón (mpg)**. Este valor ha **mejorado** en comparación con el modelo completo (que tenía \~3.40). |
| **R²** *(R-squared)*                 | `0.903` | El modelo reducido explica el **90.3% de la variación de `mpg`**, lo cual es **mejor** que el 84.5% del modelo completo.                                          |
| **MAE** *(Mean Absolute Error)*      | `2.30`  | El error absoluto medio también es **menor**, lo cual es positivo.                                                                                                 |
...
> Accesible y práctico, con aplicaciones modernas en machine learning. Capítulos 3 y 6 explican OLS en el contexto de predicción.

Fox, J., & Weisberg, S. (2019). *An R companion to applied regression* (3rd ed.). Sage.

> Muy útil para usuarios de R; cubre desde OLS básico hasta diagnósticos avanzados con funciones específicas.


Montgomery, D. C., Peck, E. A., & Vining, G. G. (2012). *Introduction to linear regression analysis* (5th ed.). Wiley.

> Excelente para profundizar en supuestos, pruebas de normalidad, heterocedasticidad, multicolinealidad, etc.
