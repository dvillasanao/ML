...
**Validación Cruzada K-Fold (K-Fold Cross-Validation):**
  * Es el tipo más popular. El conjunto de datos se divide en $k$ folds. El proceso descrito anteriormente se aplica.
